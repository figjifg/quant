...
| excluded_years | [2016] |
| macro_gate | D009 ten variables transformed to 48-month rolling z-scores, sign-adjusted, averaged by five equal-weight factor blocks; ON when composite >= -0.2 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 1.9768396305934783 | -0.3392346174957135 | 7 | 0.07553742918705231 | 0.173656816401062 | 0.43498107792439267 | 130 | 0.10753483585148099 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 2.2414636513166486 |
| d001_cumulative_net_total_return | 1.2906841868750734 |
| d001_cost_0_cumulative_net_total_return | 1.397144393892741 |
| d009_minus_d001_cumulative_net_pp | 0.686155443718405 |
| d009_minus_d001_cost_0_cumulative_net_pp | 0.8443192574239076 |
| regime_on_share | 0.4426229508196721 |
...
| return_2025_contribution_share | 0.2868261116161395 |
| d001_trade_quarter_overlap_jaccard | 0.3333333333333333 |
| d009_on_d001_off_quarter_count | 17 |
...
| 2015.0 | -0.13939080571821383 | 0.16501292442133764 | 0.0 | 0.0 | -0.13939080571821383 |
| 2017.0 | 0.0940147223548613 | 0.31675953872996554 | 0.0 | 0.0 | 0.0940147223548613 |
| 2018.0 | -0.03586254487531937 | -0.08401784948302582 | 0.0 | 0.0 | -0.03586254487531937 |
| 2019.0 | 0.02774934830525999 | 0.17019485930094325 | 0.0 | 0.0277493483052602 | -2.0816681711721685e-16 |
...
| 2022.0 | -0.09716827644733161 | -0.18442405395793493 | 0.0 | 0.0 | -0.09716827644733161 |
| 2023.0 | 0.08224211251730673 | 0.3279894204214897 | 0.0 | -0.0177293971971159 | 0.09997150971442263 |
| 2024.0 | 0.01408182625352028 | 0.034981455283805474 | 0.0 | 0.0422472179791628 | -0.028165391725642523 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2010-2017 | 2010-01-04 | 2017-12-31 | -0.056013565443905344 | -0.040569615333607034 | -0.008361469793219833 | -0.006014620252653979 | -0.2336451339675002 | -0.22865380926641588 | 25 | 25 |
| 2018-2026 | 2018-01-01 | 2026-05-04 | 2.1522118803775654 | 2.374947106344723 | 0.15197504586525 | 0.16170793764891744 | -0.3392346174957135 | -0.3393494236202602 | 105 | 105 |
...
| --- | --- | --- | --- | --- | --- |
| 48 | H1 | 60-month D014 reproduces D013 Sharpe 0.5334 | 0.43498107792439267 | 0.5334 | <NA> |
| 48 | H7 | Window Sharpe is at least 0.40 for plateau count | 0.43498107792439267 | 0.4 | True |
| 48 | H8 | 2010-2014 warmup-artifact trade count and return diagnostic | 0.0 | >0 for 36mo/48mo | False |
| 48 | H9 | ON share, max DD, and composite distribution are descriptive checks | 0.4426229508196721 |  | <NA> |
