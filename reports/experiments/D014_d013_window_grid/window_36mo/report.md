...
| excluded_years | [2016] |
| macro_gate | D009 ten variables transformed to 36-month rolling z-scores, sign-adjusted, averaged by five equal-weight factor blocks; ON when composite >= -0.2 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 1.2089924261849547 | -0.41800741433772404 | 7 | 0.054330267209729444 | 0.18072977539308513 | 0.30061602794316405 | 155 | 0.09536645907546587 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 1.4452635520856925 |
| d001_cumulative_net_total_return | 1.2906841868750734 |
| d001_cost_0_cumulative_net_total_return | 1.397144393892741 |
| d009_minus_d001_cumulative_net_pp | -0.08169176069011863 |
| d009_minus_d001_cost_0_cumulative_net_pp | 0.04811915819295143 |
| regime_on_share | 0.5245901639344263 |
...
| return_2025_contribution_share | 0.6341275486466624 |
| d001_trade_quarter_overlap_jaccard | 0.36363636363636365 |
| d009_on_d001_off_quarter_count | 20 |
| d009_off_d001_on_quarter_count | 2 |
...
| 2015.0 | -0.13939080571821405 | 0.16501292442133764 | 0.0 | 0.0 | -0.13939080571821405 |
...
| 2020.0 | 0.0904590791949893 | 0.5251287429311848 | 0.0 | 0.2461360848272729 | -0.1556770056322836 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2010-2017 | 2010-01-04 | 2017-12-31 | -0.1642972160321734 | -0.1391802048666103 | -0.02580543382835332 | -0.021594221157704818 | -0.32673908325646683 | -0.3178818306963549 | 45 | 45 |
| 2018-2026 | 2018-01-01 | 2026-05-04 | 1.6422146364362797 | 1.8376100411104273 | 0.12719232831001426 | 0.13714586832561637 | -0.3392346174957135 | -0.3393494236202603 | 110 | 110 |
...
| --- | --- | --- | --- | --- | --- |
| 36 | H1 | 60-month D014 reproduces D013 Sharpe 0.5334 | 0.30061602794316405 | 0.5334 | <NA> |
| 36 | H7 | Window Sharpe is at least 0.40 for plateau count | 0.30061602794316405 | 0.4 | False |
| 36 | H8 | 2010-2014 warmup-artifact trade count and return diagnostic | 20.0 | >0 for 36mo/48mo | True |
| 36 | H9 | ON share, max DD, and composite distribution are descriptive checks | 0.5245901639344263 |  | <NA> |
