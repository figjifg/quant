...
| v17_minus_v11_cumulative_net_pp | 0.0 |
| v17_minus_v11_cost_0_cumulative_net_pp | 0.0 |
| regime_on_share | 0.8360655737704918 |
| jp10y_favorable_quarters | 27 |
| jp10y_total_quarters_with_data | 54 |
| jp10y_missing_quarters | 0 |
| jp10y_yoy_change_us10y_yoy_change_correlation | 0.33213350422752724 |
| jp10y_yoy_change_kr10y_yoy_change_correlation | 0.3364140938124681 |
| jp10y_yoy_change_usdjpy_yoy_correlation | 0.042793619080922086 |

## Quarterly Year Breakdown

| year | macro_gate_mcap_net_total_return | kospi_buy_and_hold_net_total_return | cash_net_total_return | c014_v11_macro_gate_mcap_net_total_return | v17_minus_v11_macro_gate_mcap_return |
| --- | --- | --- | --- | --- | --- |
...
| H7 | V1 v17 cumulative net improves on C014 v11 by >= 5pp | 0.0 | 0.05 | False |
| H8 | C020 V1 subperiod cumulative net is >= 0 in both 2010-2017 and 2018-2026 | -0.08160168142041113 | 0.0 | False |
| H9 | JP10y yoy change correlations with US10y, KR10y, and USDJPY are descriptive checks | 0.33213350422752724 | 0.7 | <NA> |
