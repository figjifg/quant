...
- Files scanned (.py only): **242** across `src/`, `research/`, `scripts/`, `configs/`, `paper_trading/`, `reports/`.
- Callsites recorded: **989**.
- Distinct columns referenced: **43**.
- Classification: PASS=72 / GUARDED=352 / MISSING_GUARD=95 / INVALID_ROW_LEAK=51 / AMBIGUOUS=0 / NOT_APPLICABLE=419.
...
| `adj_close` | 16 |
| `거래량` | 12 |
| `kospi_foreign_net` | 11 |
| `kospi_institution_net` | 10 |
| `Change` | 10 |
| `외국인순매매량` | 10 |
| `adj_open` | 10 |
