...
| v14_minus_v11_cumulative_net_pp | -0.421313564835194 |
| v14_minus_v11_cost_0_cumulative_net_pp | -0.47521649485532613 |
| regime_on_share | 0.8852459016393442 |
| kr_exports_favorable_quarters | 33 |
| kr_exports_total_quarters_with_data | 54 |
| kr_exports_missing_quarters | 0 |
| kr_exports_yoy_brent_yoy_correlation | 0.5432915958502993 |
| kr_exports_yoy_usdkrw_yoy_correlation | 0.2904798269334842 |
| kr_exports_yoy_us_cpi_decel_correlation | 0.7235905593886023 |
| kr_exports_yoy_us_ppi_decel_correlation | 0.6484864102003143 |

## Quarterly Year Breakdown

| year | macro_gate_mcap_net_total_return | kospi_buy_and_hold_net_total_return | cash_net_total_return | c014_v11_macro_gate_mcap_net_total_return | v14_minus_v11_macro_gate_mcap_return |
| --- | --- | --- | --- | --- | --- |
...
| H7 | V1 v14 cumulative net improves on C014 v11 by >= 5pp | -0.421313564835194 | 0.05 | False |
| H8 | C017 V1 subperiod cumulative net is >= 0 in both 2010-2017 and 2018-2026 | -0.08160168142041113 | 0.0 | False |
| H9 | KR exports yoy correlations with Brent, USDKRW, US CPI, and US PPI are descriptive checks | 0.7235905593886023 | 0.7 | <NA> |
