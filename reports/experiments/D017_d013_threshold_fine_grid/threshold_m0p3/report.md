# D011 Threshold -0.3 Metrics Summary
...
| excluded_years | [2016] |
| macro_gate | D009 ten variables transformed to 60-month rolling z-scores, sign-adjusted, averaged by five equal-weight factor blocks; ON when composite >= -0.3 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 1.7888548181431099 | -0.48094774438612786 | 7 | 0.07086417952805024 | 0.18943755398248696 | 0.3740767236395032 | 125 | 0.09647446470258664 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 2.0273913643712933 |
| d001_cumulative_net_total_return | 1.2906841868750734 |
| d001_cost_0_cumulative_net_total_return | 1.397144393892741 |
| d009_minus_d001_cumulative_net_pp | 0.4981706312680365 |
| d009_minus_d001_cost_0_cumulative_net_pp | 0.6302469704785523 |
...
| return_2025_contribution_share | 0.3849117232848971 |
| d001_trade_quarter_overlap_jaccard | 0.39285714285714285 |
| d009_on_d001_off_quarter_count | 16 |
| d009_off_d001_on_quarter_count | 3 |
...
| 2018.0 | -0.2767152123290647 | -0.08401784948302582 | 0.0 | 0.0 | -0.2767152123290647 |
| 2019.0 | 0.027749348305260435 | 0.17019485930094325 | 0.0 | 0.0277493483052602 | 2.3592239273284576e-16 |
| 2020.0 | 0.4630990404450499 | 0.5251287429311848 | 0.0 | 0.2461360848272729 | 0.216962955617777 |
| 2021.0 | -0.12419945981131275 | 0.13170240063376726 | 0.0 | -0.035316520549102 | -0.08888293926221075 |
...
| 2024.0 | 0.014081826253520058 | 0.034981455283805474 | 0.0 | 0.0422472179791628 | -0.028165391725642745 |
| 2025.0 | 0.6885511907579556 | 1.047004780803555 | 0.0 | 0.7666554035490463 | -0.0781042127910907 |
...
| 2018-2026 | 2018-01-01 | 2026-05-04 | 1.54817033843154 | 1.746481934385674 | 0.12216952394951797 | 0.1325811014439331 | -0.48094774438612786 | -0.47417870708260645 | 115 | 115 |

## Verdict Summary

| threshold | hypothesis | description | value | threshold_value | passes |
| --- | --- | --- | --- | --- | --- |
| -0.3 | H1 | Threshold 0.0 reproduces D009 Sharpe 0.4144 | 0.3740767236395032 | 0.4144 | <NA> |
| -0.3 | H7 | Threshold Sharpe is at least 0.40 for plateau count | 0.3740767236395032 | 0.4 | False |
| -0.3 | H8 | ON share, trade count, max DD, and subperiod returns are descriptive checks | 0.4426229508196721 |  | <NA> |
