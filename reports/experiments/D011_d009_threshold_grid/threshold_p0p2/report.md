# D011 Threshold 0.2 Metrics Summary
...
| excluded_years | [2016] |
| macro_gate | D009 ten variables transformed to 60-month rolling z-scores, sign-adjusted, averaged by five equal-weight factor blocks; ON when composite >= 0.2 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 0.7558065692171194 | -0.33368186647060516 | 3 | 0.03829325318144794 | 0.11361186465886895 | 0.33705329365403236 | 50 | 0.04252341965205452 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 0.8143008698803009 |
| d001_cumulative_net_total_return | 1.2906841868750734 |
| d001_cost_0_cumulative_net_total_return | 1.397144393892741 |
| d009_minus_d001_cumulative_net_pp | -0.5348776176579539 |
| d009_minus_d001_cost_0_cumulative_net_pp | -0.5828435240124401 |
...
| return_2025_contribution_share | 0.0 |
| d001_trade_quarter_overlap_jaccard | 0.09090909090909091 |
| d009_on_d001_off_quarter_count | 9 |
| d009_off_d001_on_quarter_count | 12 |
...
| 2024.0 | 0.0 | 0.034981455283805474 | 0.0 | 0.0422472179791628 | -0.0422472179791628 |
| 2025.0 | 0.0 | 1.047004780803555 | 0.0 | 0.7666554035490463 | -0.7666554035490463 |
...
| 2018-2026 | 2018-01-01 | 2026-05-04 | 0.6049204213977621 | 0.6477002388560869 | 0.06002839213092259 | 0.06347022188765217 | -0.33368186647060516 | -0.3249118089570774 | 40 | 40 |

## Verdict Summary

| threshold | hypothesis | description | value | threshold_value | passes |
| --- | --- | --- | --- | --- | --- |
| 0.2 | H1 | Threshold 0.0 reproduces D009 Sharpe 0.4144 | 0.33705329365403236 | 0.4144 | <NA> |
| 0.2 | H7 | Threshold Sharpe is at least 0.40 for plateau count | 0.33705329365403236 | 0.4 | False |
| 0.2 | H8 | ON share, trade count, max DD, and subperiod returns are descriptive checks | 0.18032786885245902 |  | <NA> |
