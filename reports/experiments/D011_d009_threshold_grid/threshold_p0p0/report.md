...
| --- | --- | --- | --- | --- | --- |
| 0.0 | H1 | Threshold 0.0 reproduces D009 Sharpe 0.4144 | 0.4144010855755797 | 0.4144 | True |
| 0.0 | H7 | Threshold Sharpe is at least 0.40 for plateau count | 0.4144010855755797 | 0.4 | True |
| 0.0 | H8 | ON share, trade count, max DD, and subperiod returns are descriptive checks | 0.26229508196721313 |  | <NA> |
