# D011 Threshold 0.1 Metrics Summary
...
| excluded_years | [2016] |
| macro_gate | D009 ten variables transformed to 60-month rolling z-scores, sign-adjusted, averaged by five equal-weight factor blocks; ON when composite >= 0.1 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 1.2012657144272754 | -0.33368186647060516 | 4 | 0.05408367996462138 | 0.1269877938718404 | 0.4258966812133466 | 60 | 0.052835694103128515 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 1.289087724461913 |
| d001_cumulative_net_total_return | 1.2906841868750734 |
| d001_cost_0_cumulative_net_total_return | 1.397144393892741 |
| d009_minus_d001_cumulative_net_pp | -0.08941847244779799 |
| d009_minus_d001_cost_0_cumulative_net_pp | -0.10805666943082803 |
...
| return_2025_contribution_share | 0.31170411077338933 |
| d001_trade_quarter_overlap_jaccard | 0.18181818181818182 |
| d009_on_d001_off_quarter_count | 9 |
| d009_off_d001_on_quarter_count | 10 |
...
| 2025.0 | 0.3744394613181141 | 1.047004780803555 | 0.0 | 0.7666554035490463 | -0.39221594223093215 |
| 2026.0 | 0.5621484118981515 | 0.7344109727369705 | 0.0 | 0.0 | 0.5621484118981515 |
...
| 2018-2026 | 2018-01-01 | 2026-05-04 | 1.012098804017063 | 1.0788891484174128 | 0.08997844406553313 | 0.09437338767078662 | -0.33368186647060516 | -0.3249118089570774 | 50 | 50 |

## Verdict Summary

| threshold | hypothesis | description | value | threshold_value | passes |
| --- | --- | --- | --- | --- | --- |
| 0.1 | H1 | Threshold 0.0 reproduces D009 Sharpe 0.4144 | 0.4258966812133466 | 0.4144 | <NA> |
| 0.1 | H7 | Threshold Sharpe is at least 0.40 for plateau count | 0.4258966812133466 | 0.4 | True |
| 0.1 | H8 | ON share, trade count, max DD, and subperiod returns are descriptive checks | 0.21311475409836064 |  | <NA> |
