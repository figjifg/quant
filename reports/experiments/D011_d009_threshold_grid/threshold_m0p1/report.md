...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 1.535184731805431 | -0.3392346174957135 | 6 | 0.06406865037187481 | 0.15388409470664355 | 0.4163435506054858 | 95 | 0.07699088987164354 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 1.6973069627318877 |
| d001_cumulative_net_total_return | 1.2906841868750734 |
| d001_cost_0_cumulative_net_total_return | 1.397144393892741 |
| d009_minus_d001_cumulative_net_pp | 0.24450054493035767 |
| d009_minus_d001_cost_0_cumulative_net_pp | 0.3001625688391467 |
| regime_on_share | 0.32786885245901637 |
...
| return_2025_contribution_share | 0.36934266787879677 |
| d001_trade_quarter_overlap_jaccard | 0.375 |
| d009_on_d001_off_quarter_count | 11 |
...
| 2018-2026 | 2018-01-01 | 2026-05-04 | 1.3163925543934925 | 1.4470258228982837 | 0.10905950472668113 | 0.11658274458590889 | -0.3392346174957135 | -0.3393494236202602 | 85 | 85 |

## Verdict Summary

| threshold | hypothesis | description | value | threshold_value | passes |
| --- | --- | --- | --- | --- | --- |
| -0.1 | H1 | Threshold 0.0 reproduces D009 Sharpe 0.4144 | 0.4163435506054858 | 0.4144 | <NA> |
| -0.1 | H7 | Threshold Sharpe is at least 0.40 for plateau count | 0.4163435506054858 | 0.4 | True |
| -0.1 | H8 | ON share, trade count, max DD, and subperiod returns are descriptive checks | 0.32786885245901637 |  | <NA> |
