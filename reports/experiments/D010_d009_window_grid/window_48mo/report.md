...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 1.391481205037107 | -0.33368186647060516 | 5 | 0.059931749131977075 | 0.13951861154621842 | 0.4295609629982839 | 85 | 0.06602915607215928 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 1.5276487593934163 |
| d001_cumulative_net_total_return | 1.2906841868750734 |
| d001_cost_0_cumulative_net_total_return | 1.397144393892741 |
| d009_minus_d001_cumulative_net_pp | 0.10079701816203368 |
| d009_minus_d001_cost_0_cumulative_net_pp | 0.13050436550067523 |
| regime_on_share | 0.29508196721311475 |
| composite_mean | -0.007285420252061863 |
| composite_std | 0.43514459802287203 |
| composite_positive_share | 0.42857142857142855 |
...
| growth_avg_score | 0.1862694771756494 |
| return_2025_contribution_share | 0.40748608208236103 |
| d001_trade_quarter_overlap_jaccard | 0.24 |
| d009_on_d001_off_quarter_count | 12 |
...
| kr_cli_value_z_mean | 0.2301894791776879 |
| kr_cli_value_z_std | 1.3166478984115517 |
...
| 2015.0 | -0.11587815998293416 | 0.16501292442133764 | 0.0 | 0.0 | -0.11587815998293416 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2010-2017 | 2010-01-04 | 2017-12-31 | -0.03022297575220423 | -0.01757568505469531 | -0.004460343605521722 | -0.002579590117491759 | -0.19282466095585937 | -0.18753475137247677 | 20 | 20 |
| 2018-2026 | 2018-01-01 | 2026-05-04 | 1.4650219874126038 | 1.570140734481987 | 0.11759140164744442 | 0.12335731298979691 | -0.33368186647060516 | -0.32491180895707783 | 65 | 65 |
...
| --- | --- | --- | --- | --- | --- |
| 48 | H1 | 60-month D010 reproduces D009 Sharpe 0.4144 | 0.4295609629982839 | 0.4144 | <NA> |
| 48 | H7 | Window Sharpe is at least 0.40 for plateau count | 0.4295609629982839 | 0.4 | True |
| 48 | H8 | 2010-2014 warmup-artifact trade count and return diagnostic | 0.0 | >0 for 36mo/48mo | False |
| 48 | H9 | ON share, max DD, and composite distribution are descriptive checks | 0.29508196721311475 |  | <NA> |
