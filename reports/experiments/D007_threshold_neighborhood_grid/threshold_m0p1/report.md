# D007 Threshold -0.1 Metrics Summary
...
| excluded_years | [2016] |
| macro_gate | D001 eight raw variables transformed to 60-month rolling z-scores, sign-adjusted, averaged by six equal-weight factor blocks; ON when composite >= -0.1 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| factor_macro_gate_mcap | 1.0278448541003073 | -0.3392346174957134 | 4 | 0.048325362358622836 | 0.13061516234689494 | 0.3699827913567774 | 75 | 0.05918120201962765 |
...
| metric | value |
| --- | ---: |
| cost_0_cumulative_net_total_return | 1.1288669005414995 |
| regime_on_share | 0.2459016393442623 |
| regime_on_share_complete_quarters | 0.46875 |
...
| 2020.0 | 0.12199314377777437 | 0.5251287429311848 | 0.0 |
| 2021.0 | -0.03531652054910239 | 0.13170240063376726 | 0.0 |
...
| 2018-2026 | 2018-01-01 | 2026-05-04 | 1.0278448541003073 | 1.1288669005414995 | 0.09102596390640194 | 0.09758176302785815 | -0.3392346174957134 | -0.3393494236202603 | 75 | 75 |

## Verdict Summary

| threshold | hypothesis | description | value | threshold_value | passes |
| --- | --- | --- | --- | --- | --- |
| -0.1 | H1 | Threshold 0.0 reproduces D001 Sharpe 0.4842 | 0.3699827913567774 | 0.4842 | <NA> |
| -0.1 | H7 | Threshold Sharpe is at least 0.40 for plateau count | 0.3699827913567774 | 0.4 | False |
| -0.1 | H8 | ON share, trade count, max DD, and subperiod returns are descriptive checks | 0.2459016393442623 |  | <NA> |
