...
| v13_minus_v11_cumulative_net_pp | 0.0 |
| v13_minus_v11_cost_0_cumulative_net_pp | 0.0 |
| regime_on_share | 0.8360655737704918 |
| kr_cpi_favorable_quarters | 31 |
| kr_cpi_total_quarters_with_data | 50 |
| kr_cpi_missing_quarters | 4 |
| kr_cpi_decel_us_cpi_decel_correlation | 0.8263546484033611 |
| kr_cpi_decel_brent_yoy_correlation | 0.35237344495521467 |

## Quarterly Year Breakdown

| year | macro_gate_mcap_net_total_return | kospi_buy_and_hold_net_total_return | cash_net_total_return | c014_v11_macro_gate_mcap_net_total_return | v13_minus_v11_macro_gate_mcap_return |
| --- | --- | --- | --- | --- | --- |
...
| H7 | V1 v13 cumulative net improves on C014 v11 by >= 5pp | 0.0 | 0.05 | False |
| H8 | C016 V1 subperiod cumulative net is >= 0 in both 2010-2017 and 2018-2026 | -0.08160168142041113 | 0.0 | False |
| H9 | KR CPI decel vs US CPI decel correlation is a descriptive redundancy check | 0.8263546484033611 | 0.7 | <NA> |
