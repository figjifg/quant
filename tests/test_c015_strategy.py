...
from src.strategies.c015_quarterly_macro_v12 import run_c015_variants


def test_c015_unrate_nine_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "US_UNRATE_yoy_change": [0.2] * len(signal_dates),
            ...
            "favorable_US_UNRATE": [True] * len(signal_dates),
