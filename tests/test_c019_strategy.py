...
from src.strategies.c019_quarterly_macro_v16 import run_c019_variants


def test_c019_usdjpy_nine_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "favorable_USDJPY": [True] * len(signal_dates),
