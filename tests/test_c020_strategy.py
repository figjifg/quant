...
from src.strategies.c020_quarterly_macro_v17 import run_c020_variants


def test_c020_jp10y_nine_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "USDJPY_yoy": [0.05] * len(signal_dates),
            "JP10Y_yoy_change": [-0.05] * len(signal_dates),
            ...
            "favorable_JP10Y": [True] * len(signal_dates),
