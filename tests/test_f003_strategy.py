...
from src.strategies.f003_foreign_flow_d013_direct import build_f003_foreign_flow_d013_direct_candidates
from src.strategies.f003_foreign_flow_e014 import build_f003_foreign_flow_e014_candidates


def test_f003_d013_direct_selects_universe_wide_stock_foreign_flow_top5() -> None:
    ...
    assert candidates["stock_foreign_flow_score_universe"].is_monotonic_decreasing


def test_f003_e014_selects_stock_foreign_flow_within_selected_top4_sectors() -> None:
            ...
            rows.append(
                {
                    ...
                    "raw_stock_foreign_flow_score": float(ticker_number),
                    "stock_foreign_flow_score": float(offset),
                }
            )
