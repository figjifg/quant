...
from src.strategies.c010_quarterly_macro_v7 import run_c010_variants


def test_c010_copper_six_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "Copper_yoy": [0.1] * len(signal_dates),
            ...
            "favorable_Copper": [True] * len(signal_dates),
