...
from src.strategies.c012_quarterly_macro_v9 import run_c012_variants


def test_c012_kr_rates_seven_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "KR3M_yoy_change": [-0.1] * len(signal_dates),
            ...
            "favorable_KR3M": [True] * len(signal_dates),
