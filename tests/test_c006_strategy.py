...
from src.strategies.c006_quarterly_macro_v5 import run_c006_variants


def test_c006_five_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "USDCNY_yoy": [0.0] * len(signal_dates),
            ...
            "favorable_USDCNY": [True] * len(signal_dates),
