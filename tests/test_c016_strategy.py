...
from src.strategies.c016_quarterly_macro_v13 import run_c016_variants


def test_c016_kr_cpi_nine_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "KR_CPI_yoy": [2.0] * len(signal_dates),
            "KR_CPI_decel": [-0.2] * len(signal_dates),
            ...
            "favorable_KR_CPI": [True] * len(signal_dates),
