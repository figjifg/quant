...
from src.strategies.f005_liquidity_d013_direct import build_f005_liquidity_d013_direct_candidates
from src.strategies.f005_liquidity_e014 import build_f005_liquidity_e014_candidates


def test_f005_d013_direct_selects_universe_wide_stock_liquidity_top5() -> None:
    ...
    assert candidates["stock_liquidity_score_universe"].is_monotonic_decreasing


def test_f005_e014_selects_stock_liquidity_within_selected_top4_sectors() -> None:
            ...
            rows.append(
                {
                    ...
                    "raw_stock_liquidity_score": float(ticker_number),
                    "stock_liquidity_score": float(offset),
                }
            )
