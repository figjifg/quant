...
from src.strategies.c017_quarterly_macro_v14 import run_c017_variants


def test_c017_kr_exports_nine_signal_quarterly_gate_uses_next_day_execution() -> None:
    ...
    return pd.DataFrame(
        {
            ...
            "KR_exports_yoy": [0.10] * len(signal_dates),
            ...
            "favorable_KR_exports": [True] * len(signal_dates),
