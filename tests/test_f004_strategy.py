...
from src.strategies.f004_institution_flow_d013_direct import build_f004_institution_flow_d013_direct_candidates
from src.strategies.f004_institution_flow_e014 import build_f004_institution_flow_e014_candidates


def test_f004_d013_direct_selects_universe_wide_stock_institution_flow_top5() -> None:
    ...
    assert candidates["stock_institution_flow_score_universe"].is_monotonic_decreasing


def test_f004_e014_selects_stock_institution_flow_within_selected_top4_sectors() -> None:
            ...
            rows.append(
                {
                    ...
                    "raw_stock_institution_flow_score": float(ticker_number),
                    "stock_institution_flow_score": float(offset),
                }
            )
