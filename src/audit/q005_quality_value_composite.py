...
def main() -> int:
    parser = argparse.ArgumentParser(description="Q005 pre-registered US quality-value composite audit.")
    ...
    run_q_family("Q005", args.fundamental_dir, args.price_dir, args.etf_dir, args.q001_report_dir, args.report_dir)
    return 0
