...
- **Diagnostic LOCAL-ONLY DESIGN.** NOT approval to run backtest.
...
- **Recommended gate:** `DESIGN_READY_FOR_SEPARATE_DIAGNOSTIC_EXECUTION_DECISION`.
- **Next:** Bridge initial pass to Referee for gate verdict. Any actual execution requires SEPARATE user + Referee decision and a SEPARATE execution phase.
