...
### C2-C3-DESIGN-FINALIZATION (2026-05-23 Referee verdict, design-only)

Referee 가 S2 close 직후 next active work 로 `C2-C3-DESIGN-FINALIZATION` 승인.
...
- No strategy testing / performance / production / paper / P08 / live readiness

**9 required outputs**: `reports/experiments/C2_C3_design_finalization/` 에 모두 작성됨.

- `c2_c3_design_referee_lock.md`
- `c2_c3_input_state_taxonomy.md` (10 states)
- `event_source_state_rules.md` (per event type)
- `c2_factor_chain_prerequisites.md`
- `c3_corporate_action_day_prerequisites.md`
- `parser_output_acceptance_gates.md` (6 gates)
- `downstream_strategy_blockers.md`
- `future_phase_dependency_graph.md`
- `c2_c3_design_final_summary.md`

**End condition** (Referee): design-only bundle 반환, 추가 strategy/production 권유 X.

다음 Referee verdict 가 (a) 이 phase 종료 + 다음 phase 선택, 또는 (b) design 수정
요구, 또는 (c) hold 중 결정.
