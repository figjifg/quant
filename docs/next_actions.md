...
### BX01-KOSPI200-SPECIALS-TITLE-ENRICHMENT-A0 (opened 2026-05-31; initial pass 2026-05-31)

- **Phase pre-reg + addendum:** carry-forward + `reports/experiments/BX01_KOSPI200_index_event_source_A0/specials_title_enrichment_initial_pass.md`
- **Decision channel:** Referee directive `ask_0011.md` (option 3 from
  tier2-tier3 close; autonomous mode).
- **Status: INITIAL PASS COMPLETE, awaiting Referee gate verdict.**
- **Outcome:** 6/6 directive-scoped special additions title-linked at
  `high_secondary_triangulated` confidence. All 3 affected Class B cycles
  (2021-12 / 2022-06 / 2024-06) have addition-side conflation PARTIALLY
  SEPARATED. Deletion / replacement side REMAINS UNRESOLVED.
- **events_v3.csv UNCHANGED** (no events_v4 produced; candidate-link
  proposal only, NOT primary).
- **Recommended gate:** `BACKLOG_TITLE_ENRICHMENT_PARTIAL_SECONDARY_LINKS`
  (directive expected wording).
- **Next:** Bridge initial pass to Referee for gate verdict.
